...
public class ModItems {
    ...
    public static final Item GRAPPLE_HOOK = registerItem("grappling_hook", new HookItem(new Item.Settings().maxCount(1)));
    ...
    public static final Item HOOK_AXE= registerItem("hook_axe", new MultiToolItem(ToolMaterials.DIAMOND, new Item.Settings().
            attributeModifiers(MultiToolItem.createAttributeModifiers(ToolMaterials.DIAMOND, 4, -2.4F))));
    public static final Item CLIMBING_HOOK = registerItem("climbing_hook", new HookClawItem(
            ModArmourMaterials.CLIMBING_HOOK, net.minecraft.item.ArmorItem.Type.BOOTS, (new Item.Settings()).rarity(Rarity.RARE)
